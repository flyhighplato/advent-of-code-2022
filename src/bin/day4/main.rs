...
fn main() {
    let total_contains: u32 = file::lines_from_file("./src/bin/day4/input.txt")
        .iter()
        .map(|line| {
            let range_vals: Vec<u32> = line
                .split(",")
                .flat_map(|l| l.split("-"))
    ...
    let total_overlaps: u32 = file::lines_from_file("./src/bin/day4/input.txt")
        .iter()
        .map(|line| {
            let range_vals: Vec<u32> = line
                .split(",")
